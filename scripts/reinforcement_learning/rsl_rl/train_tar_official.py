...
Usage:
  python scripts/reinforcement_learning/rsl_rl/train_tar_official.py \
...
import robot_lab.tasks  # noqa: F401 -- triggers gym.register for GaitTarOfficialRough

from runners.tar_official_on_policy_runner import TAROfficialOnPolicyRunner
...
def main(env_cfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    train_cfg = {
        "runner": {
            "policy_class_name": "TARActorCriticOfficial",
            "algorithm_class_name": "TAROfficialPPO",
    ...
    runner = TAROfficialOnPolicyRunner(env, train_cfg, log_dir=log_dir, device=agent_cfg.device)
