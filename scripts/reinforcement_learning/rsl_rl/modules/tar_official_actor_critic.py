...
# Based on ammousa/TARLoco (CC-BY-NC-SA 4.0) by Amr Mousa, University of Manchester.
# SPDX-License-Identifier: CC-BY-NC-SA-4.0
"""TARActorCriticOfficial — paper-accurate port of TARLoco for Thunder (16 DOF).
...
class TARActorCriticOfficial(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if kwargs:
            print(f"[TAR-official] unexpected kwargs (ignored): {list(kwargs)}")
        super().__init__()
        ...
        print("\n[TAR-official] TARActorCriticOfficial initialized:")
