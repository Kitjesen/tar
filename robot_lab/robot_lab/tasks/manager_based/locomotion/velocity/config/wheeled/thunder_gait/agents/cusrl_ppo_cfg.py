...
@dataclass
class ThunderRoughTrainerCfg(TrainerCfg):
...
@dataclass
class ThunderFlatTrainerCfg(ThunderRoughTrainerCfg):
    max_iterations = 5000
    experiment_name = "thunder_flat"

@dataclass
class ThunderCrouchTrainerCfg(ThunderRoughTrainerCfg):
    max_iterations = 15000
    experiment_name = "thunder_crouch"  # ← 这里定义名字！